<template>
  <header>
    <section class="relative block w-full py-6 leading-10 text-center text-blue-900 bg-black">
      <div class="w-full px-6 mx-auto leading-10 text-center lg:px-8 max-w-7xl">
        <div class="box-border flex flex-wrap items-center justify-between -mx-4 text-blue-900">
          <div
